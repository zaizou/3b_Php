                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-3" dir="rtl">
                            ...
                            <a href="management_gestion_utilisateurs_utilisateurs"
                            ...
                            <div id="collapseOne" class="collapse in" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="fg-line">
                                                <input id="creat_input_nom" placeholder="{{ $utilisateur->nom }}  "
                                        ...
                                        <div class="col-sm-8">
                                            <div class="fg-line">
                                                <input id="creat_input_prenom" placeholder="{{ $utilisateur->prenom }}"
                                                       class="form-control compte" readonly>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="collapseThree" class="collapse in" role="tabpanel" aria-labelledby="headingThree">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="fg-line">
                                                <input id="creat_input_email" placeholder="{{ $utilisateur->email }}  "
                                        ...
                                        <div class="col-sm-8">
                                            <div class="fg-line">
                                                <input id="creat_input_telephone" placeholder="{{ $utilisateur->tel }}"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="fg-line">
                                                <input id="creat_input_addresse"
                                                       placeholder="{{ $utilisateur->address }}"
                                                       class="form-control compte" readonly>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="collapseFour" class="collapse in" role="tabpanel" aria-labelledby="headingFour">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="fg-line">
                                                <input id="creat_input_id_user" placeholder="{{ $utilisateur->username }}"
                                                       class="form-control compte" readonly>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-sm-4 m-b-20">
                                                        ...
                                                        <select class="selectpicker" title="Fonctionnalites"
                                                                ...
                                                                data-live-search="true" multiple>
                                                                    @if ($fca)
                                                                        @foreach ($fca as $key=>$fcn)
                                                                <option disabled>{{ $fcn->intitule }}</option>
                                                                @endforeach
                                                                  @endif
