...
<header>
    ...
    <div id="topHead" class="modal-fixed-footer row" style="margin-bottom: 0px">
        ...
        <div class="offset-l1 offset-s1 col l5 s11 ">
            <div class="col "><i class="topHIc zmdi zmdi-phone"></i><a style="color : #FFFFFF">+213.560.06.72</a></div>
        ...
        <nav id="headerToobar">
            <div class="nav-wrapper">
                ...
                <a href="#" class="brand-logo hide-on-small-and-down " style="margin-left: 100px"><img
                        src="{{ asset('3B-Internationle_files/99.png')}}" width="180" height="60"></a>
                <div class="row"></div>
                <ul id="topMenu" class="right">
                    ...
                    <li class="main-menu-elem"><a href="/shop" style="color: #0a0a0a">Shop</a></li>
                    <li class=" main-menu-elem"><a href="/management_gestion_dashboard" style="color: #0a0a0a">Management</a>
                    </li>
                </ul>
